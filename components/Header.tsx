                  ...
                  <div className="py-1">
                    ...
                    {authUser.role === 'admin' && (
                      <>
                        ...
                        <div className="px-4 py-2 text-xs text-slate-500 font-semibold uppercase tracking-wider">Admin</div>
                        <button
                          onClick={() => {
                            onViewChange(ViewType.UserManagement);
                            setIsUserMenuOpen(false);
                          }}
                          className="w-full text-left px-4 py-2 text-sm text-slate-700 hover:bg-slate-50 transition-colors flex items-center space-x-2"
                        >
                        ...
                        <button
                          onClick={() => {
                            onViewChange(ViewType.CategoryManagement);
                            setIsUserMenuOpen(false);
                          }}
                          className="w-full text-left px-4 py-2 text-sm text-slate-700 hover:bg-slate-50 transition-colors flex items-center space-x-2"
                        >
