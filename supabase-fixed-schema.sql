...
-- Clean up existing tables that might have wrong schema
DROP TABLE IF EXISTS activity_logs CASCADE;
DROP TABLE IF EXISTS user_preferences CASCADE;
DROP TABLE IF EXISTS notifications CASCADE;
DROP TABLE IF EXISTS frog_tasks CASCADE;
DROP TABLE IF EXISTS time_boxes CASCADE;
...
DROP FUNCTION IF EXISTS get_today_frog_task(UUID) CASCADE;
DROP FUNCTION IF EXISTS get_user_productivity_stats(UUID, DATE, DATE) CASCADE;
...
CREATE INDEX idx_tasks_frog_date ON tasks(frog_date) WHERE is_frog_task = true;
